...
public class SmartyEditorPreferencePage extends AbstractPreferencePage {

	public SmartyEditorPreferencePage() {
    ...
    private void createHeader(Composite contents) {
        ...
        String text = "Smarty editor preferences. Note that some preferences may be set on the <a>PHP Editors</a> preference page.";
