...
public class SmartyCompiler {
	final public static URL SMARTY_COMPILER=SmartyCorePlugin.getDefault()
			.getBundle().getEntry("Ressources/SmartyCompiler.php");
	...
	public static String compile(IFile file) throws Exception {
		...
		String[] args= { phpExe, compilerFilename,
