...
%implements BlockTokenizer, PHPRegionContext, DOMRegionContext, SmartyRegionContext
...
// added states to SMARTY
%state ST_SMARTY_CONTENT
%state ST_SMARTY_DOUBLE_QUOTES
%state ST_SMARTY_DOUBLE_QUOTES_SPECIAL
...
<ST_SMARTY_CONTENT> {NUMBER} {
    return SMARTY_NUMBER;
}

<ST_SMARTY_CONTENT> {SMARTY_COMMENT} {
	return SMARTY_COMMENT;
}

<ST_SMARTY_CONTENT> {SMARTY_WHITESPACE} {
...
<ST_SMARTY_DOUBLE_QUOTES> "$"{LABEL} {
    return SMARTY_VARIABLE;
}

<ST_SMARTY_DOUBLE_QUOTES> "$"{LABEL}[\[]{NUMBER}[\]] {
    return SMARTY_VARIABLE;
}

<ST_SMARTY_DOUBLE_QUOTES> "$"{LABEL}[\[]{LABEL}[\]] {
    return SMARTY_VARIABLE;
}
...
<ST_SMARTY_DOUBLE_QUOTES_SPECIAL> ([\`]) {
	yybegin(ST_SMARTY_DOUBLE_QUOTES);
    return SMARTY_BACKTICK_END;
}

<ST_SMARTY_DOUBLE_QUOTES_SPECIAL> "$"{LABEL} {
    return SMARTY_VARIABLE;
}
...
<ST_SMARTY_DOUBLE_QUOTES_SPECIAL> {NUMBER} {
    return SMARTY_NUMBER;
}
